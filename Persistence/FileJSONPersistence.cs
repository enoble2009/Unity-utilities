...
public class FileJSONPersistence
{
    ...
    public static void Save<T>(T objectToSave, string filename)
    {
        ...
        // Saving data in file.
        string json = Object2JSON<T>(objectToSave);
        Debug.Log(string.Format("Data saving: {0}", json));
    ...
    public static T Load<T>(string filename)
    {
        ...
        if (File.Exists(fileFullPath))
        {
            ...
            Debug.Log(string.Format("Data loading: {0}", json));
            T obj = JSON2Object<T>(json);
    ...
    {
        Save<ExampleSavedObject>(exObj, "example-object.save");
    }
    ...
    private static string Object2JSON<T>(T o)
    {
